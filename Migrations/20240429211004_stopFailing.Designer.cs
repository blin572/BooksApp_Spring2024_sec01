...
namespace BooksApp_Spring2024_sec01.Migrations
{
    ...
    [Migration("20240429211004_stopFailing")]
    partial class stopFailing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.Models.Cart", b =>
                {
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.Models.Cart", b =>
                {
                    b.HasOne("BooksApp_Spring2024_sec01.Models.Books", "Books")
                        .WithMany()
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BooksApp_Spring2024_sec01.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BooksApp_Spring2024_sec01.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BooksApp_Spring2024_sec01.Models.Order", "Order")
                        .WithMany()
